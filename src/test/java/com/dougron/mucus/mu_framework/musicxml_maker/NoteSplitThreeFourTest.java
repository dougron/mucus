...
public class NoteSplitThreeFourTest
{
...
//				"rest: offset=2.0 length=1.0\n" + 
				...
				"measure=7\n" + 
				"note: notes=56, offset=0.0 length=1.0 tieStart\n" + 
				"note: notes=56, offset=1.0 length=0.75 tieEnd\n" + 
				"rest: offset=1.75 length=0.25\n" + 
				"rest: offset=2.0 length=1.0\n" + 
				"measure=8\n" + 
				"note: notes=56, offset=0.0 length=2.0\n" + 
				"rest: offset=2.0 length=1.0\n" + 
				"measure=9\n" + 
				"note: notes=56, offset=0.0 length=2.0 tieStart\n" + 
				"note: notes=56, offset=2.0 length=0.25 tieEnd\n" + 
				"rest: offset=2.25 length=0.25\n" + 
				"rest: offset=2.5 length=0.5\n" + 
				"measure=10\n" + 
				"note: notes=56, offset=0.0 length=1.0 tieStart\n" + 
				"note: notes=56, offset=1.0 length=1.5 tieEnd\n" + 
				"rest: offset=2.5 length=0.5\n" + 
				"measure=11\n" + 
				"note: notes=56, offset=0.0 length=2.0 tieStart\n" + 
				"note: notes=56, offset=2.0 length=0.75 tieEnd\n" + 
				"rest: offset=2.75 length=0.25\n" + 
				"measure=12\n" + 
				"note: notes=56, offset=0.0 length=3.0\n" + 
				"measure=13\n" + 
...
//				"rest: offset=2.0 length=1.0\n" + 
				...
				"rest: offset=0.0 length=0.25\n" + 
				"note: notes=56, offset=0.25 length=0.75 tieStart\n" + 
				"note: notes=56, offset=1.0 length=1.0 tieEnd\n" + 
				"rest: offset=2.0 length=1.0\n" + 
				"measure=20\n" + 
				"rest: offset=0.0 length=0.25\n" + 
				"note: notes=56, offset=0.25 length=0.75 tieStart\n" + 
				"note: notes=56, offset=1.0 length=1.0 tieEnd tieStart\n" + 
				"note: notes=56, offset=2.0 length=0.25 tieEnd\n" + 
				"rest: offset=2.25 length=0.25\n" + 
				"rest: offset=2.5 length=0.5\n" + 
				"measure=21\n" + 
				...
				"rest: offset=0.0 length=0.25\n" + 
				"note: notes=56, offset=0.25 length=0.75 tieStart\n" + 
				"note: notes=56, offset=1.0 length=2.0 tieEnd\n" + 
				"measure=24\n" + 
...
//				"rest: offset=2.0 length=1.0\n" + 
				...
				"measure=29\n" + 
				"rest: offset=0.0 length=0.5\n" + 
				"note: notes=56, offset=0.5 length=1.5\n" + 
				"rest: offset=2.0 length=1.0\n" + 
				"measure=30\n" + 
				"rest: offset=0.0 length=0.5\n" + 
				"note: notes=56, offset=0.5 length=1.5 tieStart\n" + 
				"note: notes=56, offset=2.0 length=0.25 tieEnd\n" + 
				"rest: offset=2.25 length=0.25\n" + 
				"rest: offset=2.5 length=0.5\n" + 
				"measure=31\n" + 
				"rest: offset=0.0 length=0.5\n" + 
				"note: notes=56, offset=0.5 length=2.0\n" + 
				"rest: offset=2.5 length=0.5\n" + 
				"measure=32\n" + 
				"rest: offset=0.0 length=0.5\n" + 
				"note: notes=56, offset=0.5 length=1.5 tieStart\n" + 
				...
				"rest: offset=0.0 length=0.5\n" + 
				"note: notes=56, offset=0.5 length=1.5 tieStart\n" + 
				"note: notes=56, offset=2.0 length=1.0 tieEnd\n" + 
				"measure=34\n" + 
				"rest: offset=0.0 length=0.5\n" + 
...
//				"rest: offset=2.0 length=1.0\n" + 
				...
				"measure=45\n" + 
				"rest: offset=0.0 length=1.0\n" + 
				"note: notes=56, offset=1.0 length=0.75\n" + 
				"rest: offset=1.75 length=0.25\n" + 
				"rest: offset=2.0 length=1.0\n" + 
				"measure=46\n" + 
				"rest: offset=0.0 length=1.0\n" + 
				"note: notes=56, offset=1.0 length=1.0\n" + 
				"rest: offset=2.0 length=1.0\n" + 
				"measure=47\n" + 
				"rest: offset=0.0 length=1.0\n" + 
				"note: notes=56, offset=1.0 length=1.0 tieStart\n" + 
				"note: notes=56, offset=2.0 length=0.25 tieEnd\n" + 
				"rest: offset=2.25 length=0.25\n" + 
				"rest: offset=2.5 length=0.5\n" + 
				"measure=48\n" + 
				"rest: offset=0.0 length=1.0\n" + 
				"note: notes=56, offset=1.0 length=1.5\n" + 
				"rest: offset=2.5 length=0.5\n" + 
				"measure=49\n" + 
				"rest: offset=0.0 length=1.0\n" + 
				"note: notes=56, offset=1.0 length=1.0 tieStart\n" + 
				...
				"measure=50\n" + 
				"rest: offset=0.0 length=1.0\n" + 
				"note: notes=56, offset=1.0 length=2.0\n" + 
				"measure=51\n" + 
				"rest: offset=0.0 length=1.0\n" + 
				...
				"rest: offset=0.0 length=1.0\n" + 
				"rest: offset=1.0 length=0.25\n" + 
				"note: notes=56, offset=1.25 length=0.5\n" + 
				"rest: offset=1.75 length=0.25\n" + 
				"rest: offset=2.0 length=1.0\n" + 
				"measure=53\n" + 
				"rest: offset=0.0 length=1.0\n" + 
				"rest: offset=1.0 length=0.25\n" + 
				"note: notes=56, offset=1.25 length=0.75\n" + 
				"rest: offset=2.0 length=1.0\n" + 
				"measure=54\n" + 
				"rest: offset=0.0 length=1.0\n" + 
				"rest: offset=1.0 length=0.25\n" + 
				"note: notes=56, offset=1.25 length=0.75 tieStart\n" + 
				"note: notes=56, offset=2.0 length=0.25 tieEnd\n" + 
				"rest: offset=2.25 length=0.25\n" + 
				"rest: offset=2.5 length=0.5\n" + 
				"measure=55\n" + 
				...
				"rest: offset=1.0 length=0.25\n" + 
				"note: notes=56, offset=1.25 length=0.75 tieStart\n" + 
				"note: notes=56, offset=2.0 length=0.5 tieEnd\n" + 
				"rest: offset=2.5 length=0.5\n" + 
				"measure=56\n" + 
				"rest: offset=0.0 length=1.0\n" + 
				"rest: offset=1.0 length=0.25\n" + 
				...
				"rest: offset=0.0 length=1.0\n" + 
				"rest: offset=1.0 length=0.5\n" + 
				"note: notes=56, offset=1.5 length=0.5 tieStart\n" + 
				"note: notes=56, offset=2.0 length=0.25 tieEnd\n" + 
				"rest: offset=2.25 length=0.25\n" + 
				"rest: offset=2.5 length=0.5\n" + 
				"measure=61\n" + 
				...
				"rest: offset=1.0 length=0.5\n" + 
				"rest: offset=1.5 length=0.25\n" + 
				"note: notes=56, offset=1.75 length=0.25 tieStart\n" + 
				"note: notes=56, offset=2.0 length=0.25 tieEnd\n" + 
				"rest: offset=2.25 length=0.25\n" + 
				"rest: offset=2.5 length=0.5\n" + 
				"measure=66\n" + 
...
//				"rest: offset=1.0 length=1.0\n" + 
				...
				"rest: offset=0.0 length=2.0\n" + 
//				"rest: offset=1.0 length=1.0\n" + 
				"note: notes=56, offset=2.0 length=0.75\n" + 
				"rest: offset=2.75 length=0.25\n" + 
				"measure=72\n" + 
				"rest: offset=0.0 length=2.0\n" + 
//				"rest: offset=1.0 length=1.0\n" + 
				...
				"rest: offset=1.0 length=1.0\n" + 
				"rest: offset=2.0 length=0.25\n" + 
				"note: notes=56, offset=2.25 length=0.5\n" + 
				"rest: offset=2.75 length=0.25\n" + 
				"measure=75\n" + 
				"rest: offset=0.0 length=1.0\n" + 
				"rest: offset=1.0 length=1.0\n" + 
				"rest: offset=2.0 length=0.25\n" + 
				"note: notes=56, offset=2.25 length=0.75\n" + 
				"measure=76\n" + 
				"rest: offset=0.0 length=1.0\n" + 
				"rest: offset=1.0 length=1.0\n" + 
