...
public class MugList_RhythmLongerOnAverage implements FeedbackObject
{
	...
	private MugList_RhythmLongerOnAverage ()
	{
	...
	public static FeedbackObject getInstance()
	{
		if (instance == null)
		{
			instance = new MugList_RhythmLongerOnAverage();
			excludeList = new FeedbackObject[] {MugList_RhythmShorterOnAverage.getInstance()};
		}
		return instance;
	}
	...
	{
		return "MugList_RhythmLongerOnAverage";
	}
