...
public class PhraseLength_Shorter implements FeedbackObject
{
	...
	public static FeedbackObject getInstance()
	{
		if (instance == null)
		{
			instance = new PhraseLength_Shorter();
			excludeList = new FeedbackObject[] {PhraseLength_Longer.getInstance()};
		}
		return instance;
	}
