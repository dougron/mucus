...
public class TimeSignature_MoreEven implements FeedbackObject
{
	...
	private TimeSignature_MoreEven()
	{
	...
	public static FeedbackObject getInstance()
	{
		if (instance == null)
		{
			instance = new TimeSignature_MoreEven();
			excludeList = new FeedbackObject[] {TimeSignature_LessEven.getInstance()};
		}
		return instance;
	}
