...
public class Tempo_Faster implements FeedbackObject
{
	...
	public static FeedbackObject getInstance()
	{
		if (instance == null)
		{
			instance = new Tempo_Faster();
			excludeList = new FeedbackObject[] {Tempo_Slower.getInstance()};
		}
		return instance;
	}
