...
public class StructureToneSpacing_Shorter implements FeedbackObject
{
	...
	private StructureToneSpacing_Shorter()
	{
	...
	public static FeedbackObject getInstance()
	{
		if (instance == null)
		{
			instance = new StructureToneSpacing_Shorter();
			excludeList = new FeedbackObject[] {StructureToneSpacing_Longer.getInstance()};
		}
		return instance;
	}
	...
	{		
		return "StructureToneSpacing_Shorter";
	}
