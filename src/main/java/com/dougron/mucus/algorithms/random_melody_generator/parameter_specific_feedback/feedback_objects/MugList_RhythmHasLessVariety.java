...
public class MugList_RhythmHasLessVariety implements FeedbackObject
{
	...
	private MugList_RhythmHasLessVariety ()
	{
	...
	public static FeedbackObject getInstance()
	{
		if (instance == null)
		{
			instance = new MugList_RhythmHasLessVariety();
	...
	{
		return "MugList_RhythmHasLessVariety";
	}
