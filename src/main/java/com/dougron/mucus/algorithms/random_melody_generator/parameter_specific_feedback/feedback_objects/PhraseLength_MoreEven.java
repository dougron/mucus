...
public class PhraseLength_MoreEven implements FeedbackObject
{
	...
	public static FeedbackObject getInstance()
	{
		if (instance == null)
		{
			instance = new PhraseLength_MoreEven();
			excludeList = new FeedbackObject[] {PhraseLength_LessEven.getInstance()};
		}
		return instance;
	}
