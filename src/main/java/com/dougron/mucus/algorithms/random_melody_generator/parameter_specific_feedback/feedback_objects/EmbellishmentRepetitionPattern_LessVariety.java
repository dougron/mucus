...
public class EmbellishmentRepetitionPattern_LessVariety implements FeedbackObject
{
	...
	private EmbellishmentRepetitionPattern_LessVariety()
	{
	...
	public static FeedbackObject getInstance()
	{
		if (instance == null)
		{
			instance = new EmbellishmentRepetitionPattern_LessVariety();
			excludeList = new FeedbackObject[] {EmbellishmentRepetitionPattern_MoreVariety.getInstance()};
		}
		return instance;
	}
	...
	{		
		return "EmbellishmentRepetitionPattern_LessVariety";
	}
