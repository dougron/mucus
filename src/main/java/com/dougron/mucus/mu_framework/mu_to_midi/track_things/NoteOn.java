...
public class NoteOn extends NoteThing implements MidiThing
{
	private static final int sortPriority = 100;

	
	
	public NoteOn (int aPitch, int aVelocity, int aMidiChannel, int aGlobalPosition)
	{
